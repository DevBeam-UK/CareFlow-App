export { PatientsFilterToolbarSection } from "./PatientsFilterToolbarSection";
export { PatientsTable } from "./PatientsTableSection";
export { default as PatientStatSection } from "./PatientsStatCardsSection";
...
export { PatientCommunicationTab } from "./patient-drawer/PatientCommunicationTab";
export { PatientDocumentsTab } from "./patient-drawer/PatientDocumentsTab";
export { PatientInfoTab } from "./patient-drawer/PatientInfoTab";
...
export {
  ...
  documentTypeIcon,
  documentTypeLabel,
} from "./patient-create-modal/PatientCreateModalDocStep";
export { CreatePatientModalFooter } from "./patient-create-modal/PatientCreateModalFooter";
export { PatientInfoStep } from "./patient-create-modal/PatientCreateModalInfoStep";
export { KeyContactsStep } from "./patient-create-modal/PatientCreateModalKeyContactsStep";
export { LifeStoryStep } from "./patient-create-modal/PatientCreateModalLifeStoryStep";
export { MedicalHistoryStep } from "./patient-create-modal/PatientCreateModalMedHistoryStep";
