...
import { mockStaffMembers } from "@/lib/mock/staff-mock-data";
...
export default function StaffPage() {
  ...
  return (
    <motion.div
      className="h-screen w-full p-6 border rounded-2xl shadow bg-cf-surface space-y-8 overflow-y-auto"
      variants={container}
      initial="hidden"
      animate="show"
    >
      ...
      <motion.div variants={item} className="w-full gap-x-4 flex items-center">
